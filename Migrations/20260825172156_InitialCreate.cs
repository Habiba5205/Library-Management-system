    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "RoleId", "Description", "Permissions", "RoleName" },
                values: new object[,]
                {
                    { 1, "System administrator", "Manage all modules", "Admin" },
                    { 2, "Library manager", "Manage books, authors, categories, and borrowings", "Manager" },
                    { 3, "Library member", "Borrow and return books", "Member" }
                });
